...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/charusat_symbol.jpg" width="45" alt="" class="logo-img"><b>Federal Bank</b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
			...
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to Federal Bank</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>Federal Bank</b>  is the preferred Personal, NRI and Business banking partner for a growing expanse of customers across India, in both urban and rural areas. The Bank is driven by the quest to be one of the most admired banking institutions in the country.</div>
